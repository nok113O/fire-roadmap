  ...
  return (
    <section className="card">
      ...
      <p className="form-total-hint">
        NISA成長投資枠などを使った増配株投資を想定し、投資した年ごとの元本が複利で配当を増やしていく前提でシミュレーションします。この配当収入は、セミFIRE・完全FIREの必要資産額から差し引く追加収入として計算に反映されます(配当を生む元本自体は「現在の資産」として通常通り計算されるため、二重計上にはなりません)。配当成長は「配当成長の上限年数」で頭打ちにし、達成が遅れるほど配当が際限なく育って必要資産額が過小評価されることを防いでいます。
      </p>
